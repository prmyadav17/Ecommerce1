      ...
      <div className="mx-auto bg-white mt-12 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <button
            ...
            className="rounded-md my-3 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
          ...
          <p className="mt-3 text-xl font-semibold ">Your Address :</p>
