...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Hemani", label: "Hemani", checked: false },
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <Link
                  ...
                  className="flex mx-8 justify-center rounded-md
                          bg-green-600 px-3 py-1.5 text-sm font-semibold
                          leading-6 text-white shadow-sm hover:bg-green-500
                      ...
                      {products?.map((product) => (
                        <div>
                          ...
                          <Link
                            ...
                            className="flex w-full mt-2 justify-center rounded-md
              ...
              {/* Product Grid ENd Start Pagination */}
            </div>
          </section>
          {/* Section of Product Pagination */}
          <Pagination
            page={page}
            setPage={setPage}
